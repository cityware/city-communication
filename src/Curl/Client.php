 ...
 * of cURL scripts set CURLOPT_RETURNTRANSFER to true, the {@link Client}
...
class Client {
    ...
    /**
     * Flag the Client object as linked to a {@link Parallel}
     * object.
     *
     * @var bool
     */
    ...
    /**
     * The version of the OOClient library.
     * @var string
     */
    const VERSION = '0.3';

    /**
     * Create the new {@link Client} object, with the
    ...
    public function __construct($url = NULL) {
        ...
        $this->useragent = 'OOClient ' . self::VERSION;
    ...
    /**
     * If the session was closed with {@link Client::close()}, it can be reopened.
     *
     * This does not re-execute {@link Client::__construct()}, but will reset all
    ...
    /**
     * If the Client object was added to a {@link Parallel}
    ...
    /**
     * Get cURL version information (and adds OOClient version info)
     *
     * @return array
     */
    public function version() {
        ...
        $version['oocurlparallel_version'] = Parallel::VERSION;
    ...
    /**
     * Grants access to {@link Client::$ch $ch} to a {@link Parallel} object.
     *
     * @param Parallel $mh The Parallel object that needs {@link Client::$ch $ch}.
     */
    public function grant(Parallel $mh) {
        $mh->accept($this->ch);
        $this->multi = true;
    }

    /**
     * Removes access to {@link Client::$ch $ch} from a {@link Parallel} object.
     *
     * @param Parallel $mh The Parallel object that no longer needs {@link Client::$ch $ch}.
     */
    public function revoke(Parallel $mh) {
        $mh->release($this->ch);
        $this->multi = false;
    }
